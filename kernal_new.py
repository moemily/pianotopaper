...
def do_stuff():
    ...
    # with open('boxes_straight_3.csv', mode = 'w') as boxes_file:
    #     boxes_writer = csv.writer(boxes_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    #     M = np.size(boxes,0)
    #     for i in range(0, M):
    #         boxes_writer.writerow([boxes[i,0,:], boxes[i,1,:], boxes[i,2,:], boxes[i,3,:]])
    ...
    #cv2.imwrite('Penalty_St.jpg', bw)
    #matplotlib.image.imsave('Penalty_St.jpg', bw)
